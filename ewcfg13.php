...
define("EW_PROJECT_NAME", "prj_zigzag", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{DD5F1A59-0600-49F5-9773-CB635EB1CBA9}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'O9mmFlsEP8rjmpKf', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/prj_zigzag.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_zigzag", "qs" => "`", "qe" => "`");
...
@define("EW_USER_LEVEL_PRIV_TABLE", "`t96_userlevelpermissions`", TRUE);
...
define("EW_USER_TABLE", "`t98_employees`", TRUE);
