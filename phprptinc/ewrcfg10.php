...
define("EWR_PROJECT_ID", "{77B51533-F1E4-4C23-925C-E363F9E1C0BE}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "prj_zigzag", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_zigzag", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'fo3CLz345AfMu6N9', TRUE); // Random key for encryption
...
// User admin
define("EWR_LOGIN_SELECT_SQL", "SELECT * FROM `t98_employees`", TRUE);

// User table filters
define("EWR_USER_TABLE_DBID", "DB", TRUE);
define("EWR_USER_TABLE", "`t98_employees`", TRUE);
...
define("EWR_USER_LEVEL_PRIV_TABLE", "`t96_userlevelpermissions`", TRUE);
...
define("EWR_TABLE_PREFIX", "{77B51533-F1E4-4C23-925C-E363F9E1C0BE}", TRUE);
