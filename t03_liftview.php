...
$t03_lift_view = NULL; // Initialize page object first

class ct03_lift_view extends ct03_lift {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t03_liftlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t03_liftlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t03_lift_view)) $t03_lift_view = new ct03_lift_view();

// Page init
$t03_lift_view->Page_Init();

// Page main
$t03_lift_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t03_lift_view->Page_Render();
?>
...
var CurrentForm = ft03_liftview = new ew_Form("ft03_liftview", "view");

// Form_CustomValidate event
ft03_liftview.Form_CustomValidate = 
...
ft03_liftview.ValidateRequired = true;
<?php } else { ?>
ft03_liftview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft03_liftview.Lists["x_pelayaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t02_pelayaran"};
...
<?php if ($t03_lift->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t03_lift_view->IsModal) { ?>
<?php if ($t03_lift->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t03_lift_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t03_lift_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t03_lift_view->IsModal) { ?>
<?php if ($t03_lift->Export == "") { ?>
...
<?php } ?>
<?php $t03_lift_view->ShowPageHeader(); ?>
<?php
$t03_lift_view->ShowMessage();
?>
<?php if (!$t03_lift_view->IsModal) { ?>
<?php if ($t03_lift->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t03_lift_view->Pager)) $t03_lift_view->Pager = new cPrevNextPager($t03_lift_view->StartRec, $t03_lift_view->DisplayRecs, $t03_lift_view->TotalRecs) ?>
<?php if ($t03_lift_view->Pager->RecordCount > 0 && $t03_lift_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t03_lift_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t03_lift_view->PageUrl() ?>start=<?php echo $t03_lift_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t03_lift_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t03_lift_view->PageUrl() ?>start=<?php echo $t03_lift_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t03_lift_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t03_lift_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t03_lift_view->PageUrl() ?>start=<?php echo $t03_lift_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t03_lift_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t03_lift_view->PageUrl() ?>start=<?php echo $t03_lift_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t03_lift_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft03_liftview" id="ft03_liftview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t03_lift_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t03_lift_view->Token ?>">
<?php } ?>
...
<?php if ($t03_lift->depo_id->Visible) { // depo_id ?>
	<tr id="r_depo_id">
		<td><span id="elh_t03_lift_depo_id"><?php echo $t03_lift->depo_id->FldCaption() ?></span></td>
...
<?php echo $t03_lift->depo_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_lift->pelayaran_id->Visible) { // pelayaran_id ?>
	<tr id="r_pelayaran_id">
		<td><span id="elh_t03_lift_pelayaran_id"><?php echo $t03_lift->pelayaran_id->FldCaption() ?></span></td>
...
<?php echo $t03_lift->pelayaran_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_lift->on20->Visible) { // on20 ?>
	<tr id="r_on20">
		<td><span id="elh_t03_lift_on20"><?php echo $t03_lift->on20->FldCaption() ?></span></td>
...
<?php echo $t03_lift->on20->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_lift->on40->Visible) { // on40 ?>
	<tr id="r_on40">
		<td><span id="elh_t03_lift_on40"><?php echo $t03_lift->on40->FldCaption() ?></span></td>
...
<?php echo $t03_lift->on40->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_lift->on45->Visible) { // on45 ?>
	<tr id="r_on45">
		<td><span id="elh_t03_lift_on45"><?php echo $t03_lift->on45->FldCaption() ?></span></td>
...
<?php echo $t03_lift->on45->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_lift->offket->Visible) { // offket ?>
	<tr id="r_offket">
		<td><span id="elh_t03_lift_offket"><?php echo $t03_lift->offket->FldCaption() ?></span></td>
...
<?php echo $t03_lift->offket->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_lift->off20->Visible) { // off20 ?>
	<tr id="r_off20">
		<td><span id="elh_t03_lift_off20"><?php echo $t03_lift->off20->FldCaption() ?></span></td>
...
<?php echo $t03_lift->off20->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_lift->off40->Visible) { // off40 ?>
	<tr id="r_off40">
		<td><span id="elh_t03_lift_off40"><?php echo $t03_lift->off40->FldCaption() ?></span></td>
...
<?php echo $t03_lift->off40->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_lift->off45->Visible) { // off45 ?>
	<tr id="r_off45">
		<td><span id="elh_t03_lift_off45"><?php echo $t03_lift->off45->FldCaption() ?></span></td>
...
<?php echo $t03_lift->off45->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
