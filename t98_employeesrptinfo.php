...
//
class crt98_employees extends crTableBase {
	...
	function __construct() {
		...
		// EmployeeID
		$this->EmployeeID = new crField('t98_employees', 't98_employees', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// LastName
		$this->LastName = new crField('t98_employees', 't98_employees', 'x_LastName', 'LastName', '`LastName`', 200, EWR_DATATYPE_STRING, -1);
		...
		// FirstName
		$this->FirstName = new crField('t98_employees', 't98_employees', 'x_FirstName', 'FirstName', '`FirstName`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Title
		$this->Title = new crField('t98_employees', 't98_employees', 'x_Title', 'Title', '`Title`', 200, EWR_DATATYPE_STRING, -1);
		...
		// TitleOfCourtesy
		$this->TitleOfCourtesy = new crField('t98_employees', 't98_employees', 'x_TitleOfCourtesy', 'TitleOfCourtesy', '`TitleOfCourtesy`', 200, EWR_DATATYPE_STRING, -1);
		...
		// BirthDate
		$this->BirthDate = new crField('t98_employees', 't98_employees', 'x_BirthDate', 'BirthDate', '`BirthDate`', 135, EWR_DATATYPE_DATE, 0);
		...
		// HireDate
		$this->HireDate = new crField('t98_employees', 't98_employees', 'x_HireDate', 'HireDate', '`HireDate`', 135, EWR_DATATYPE_DATE, 0);
		...
		// Address
		$this->Address = new crField('t98_employees', 't98_employees', 'x_Address', 'Address', '`Address`', 200, EWR_DATATYPE_STRING, -1);
		...
		// City
		$this->City = new crField('t98_employees', 't98_employees', 'x_City', 'City', '`City`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Region
		$this->Region = new crField('t98_employees', 't98_employees', 'x_Region', 'Region', '`Region`', 200, EWR_DATATYPE_STRING, -1);
		...
		// PostalCode
		$this->PostalCode = new crField('t98_employees', 't98_employees', 'x_PostalCode', 'PostalCode', '`PostalCode`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Country
		$this->Country = new crField('t98_employees', 't98_employees', 'x_Country', 'Country', '`Country`', 200, EWR_DATATYPE_STRING, -1);
		...
		// HomePhone
		$this->HomePhone = new crField('t98_employees', 't98_employees', 'x_HomePhone', 'HomePhone', '`HomePhone`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Extension
		$this->Extension = new crField('t98_employees', 't98_employees', 'x_Extension', 'Extension', '`Extension`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Email
		$this->_Email = new crField('t98_employees', 't98_employees', 'x__Email', 'Email', '`Email`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Photo
		$this->Photo = new crField('t98_employees', 't98_employees', 'x_Photo', 'Photo', '`Photo`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Notes
		$this->Notes = new crField('t98_employees', 't98_employees', 'x_Notes', 'Notes', '`Notes`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// ReportsTo
		$this->ReportsTo = new crField('t98_employees', 't98_employees', 'x_ReportsTo', 'ReportsTo', '`ReportsTo`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// Password
		$this->Password = new crField('t98_employees', 't98_employees', 'x_Password', 'Password', '`Password`', 200, EWR_DATATYPE_STRING, -1);
		...
		// UserLevel
		$this->UserLevel = new crField('t98_employees', 't98_employees', 'x_UserLevel', 'UserLevel', '`UserLevel`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// Username
		$this->Username = new crField('t98_employees', 't98_employees', 'x_Username', 'Username', '`Username`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Activated
		$this->Activated = new crField('t98_employees', 't98_employees', 'x_Activated', 'Activated', '`Activated`', 202, EWR_DATATYPE_STRING, -1);
		...
		// Profile
		$this->Profile = new crField('t98_employees', 't98_employees', 'x_Profile', 'Profile', '`Profile`', 201, EWR_DATATYPE_MEMO, -1);
	...
	function ChildUserIDList($sUserID) {
		...
		// Get all values
		if ($sUserID == "-1") {
			$sSql = "SELECT `EmployeeID` FROM `t98_employees`";
		} else {
			$sSql = "SELECT `EmployeeID` FROM `t98_employees` WHERE `EmployeeID` = " . ewr_QuotedValue($sUserID, EWR_DATATYPE_NUMBER, $this->DBID);
		}
