...
$t96_userlevelpermissions = NULL;

//
// Table class for t96_userlevelpermissions
//
class ct96_userlevelpermissions extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't96_userlevelpermissions';
		$this->TableName = 't96_userlevelpermissions';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t96_userlevelpermissions`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('t96_userlevelpermissions', 't96_userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new cField('t96_userlevelpermissions', 't96_userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_tablename->Sortable = TRUE; // Allow sort
		$this->fields['tablename'] = &$this->_tablename;

		// permission
		$this->permission = new cField('t96_userlevelpermissions', 't96_userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t96_userlevelpermissions`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t96_userlevelpermissionslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t96_userlevelpermissionsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t96_userlevelpermissionsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t96_userlevelpermissionsadd.php?" . $this->UrlParm($parm);
		else
			$url = "t96_userlevelpermissionsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t96_userlevelpermissionsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t96_userlevelpermissionsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t96_userlevelpermissionsdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function WriteAuditTrailDummy($typ) {
		$table = 't96_userlevelpermissions';
		$usr = CurrentUserID();
