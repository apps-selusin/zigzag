...
class cchangepwd extends ct98_employees {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t98_employees"])) $GLOBALS["t98_employees"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 't98_employees');
		}
