...
$t04_depo_edit = NULL; // Initialize page object first

class ct04_depo_edit extends ct04_depo {
	...
	function ValidateForm() {
		...
		if (in_array("t03_lift", $DetailTblVar) && $GLOBALS["t03_lift"]->DetailEdit) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// no_fax
			$this->no_fax->SetDbValueDef($rsnew, $this->no_fax->CurrentValue, NULL, $this->no_fax->ReadOnly);
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("t03_lift", $DetailTblVar) && $GLOBALS["t03_lift"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["t03_lift_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("t03_lift", $DetailTblVar)) {
				...
				if ($GLOBALS["t03_lift_grid"]->DetailEdit) {
					$GLOBALS["t03_lift_grid"]->CurrentMode = "edit";
					$GLOBALS["t03_lift_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($t04_depo_edit)) $t04_depo_edit = new ct04_depo_edit();

// Page init
$t04_depo_edit->Page_Init();

// Page main
$t04_depo_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t04_depo_edit->Page_Render();
?>
...
var CurrentForm = ft04_depoedit = new ew_Form("ft04_depoedit", "edit");

// Validate form
ft04_depoedit.Validate = function() {
...
ft04_depoedit.Form_CustomValidate = 
...
ft04_depoedit.ValidateRequired = true;
<?php } else { ?>
ft04_depoedit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $t04_depo_edit->ShowPageHeader(); ?>
<?php
$t04_depo_edit->ShowMessage();
?>
<?php if (!$t04_depo_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t04_depo_edit->Pager)) $t04_depo_edit->Pager = new cPrevNextPager($t04_depo_edit->StartRec, $t04_depo_edit->DisplayRecs, $t04_depo_edit->TotalRecs) ?>
<?php if ($t04_depo_edit->Pager->RecordCount > 0 && $t04_depo_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t04_depo_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t04_depo_edit->PageUrl() ?>start=<?php echo $t04_depo_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t04_depo_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t04_depo_edit->PageUrl() ?>start=<?php echo $t04_depo_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t04_depo_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t04_depo_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t04_depo_edit->PageUrl() ?>start=<?php echo $t04_depo_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t04_depo_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t04_depo_edit->PageUrl() ?>start=<?php echo $t04_depo_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t04_depo_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft04_depoedit" id="ft04_depoedit" class="<?php echo $t04_depo_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t04_depo_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t04_depo_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t04_depo" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t04_depo->id->CurrentValue) ?>">
<?php
	if (in_array("t03_lift", explode(",", $t04_depo->getCurrentDetailTable())) && $t03_lift->DetailEdit) {
?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t04_depo_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t04_depo_edit->Pager)) $t04_depo_edit->Pager = new cPrevNextPager($t04_depo_edit->StartRec, $t04_depo_edit->DisplayRecs, $t04_depo_edit->TotalRecs) ?>
<?php if ($t04_depo_edit->Pager->RecordCount > 0 && $t04_depo_edit->Pager->Visible) { ?>
