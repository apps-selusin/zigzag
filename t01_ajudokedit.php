...
$t01_ajudok_edit = NULL; // Initialize page object first

class ct01_ajudok_edit extends ct01_ajudok {
	...
	// Page object name
	var $PageObjName = 't01_ajudok_edit';
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->ajudok_id->FldIsDetailKey)
			$this->ajudok_id->setFormValue($objForm->GetValue("x_ajudok_id"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->ajudok_id->CurrentValue = $this->ajudok_id->FormValue;
...
// Create page object
if (!isset($t01_ajudok_edit)) $t01_ajudok_edit = new ct01_ajudok_edit();

// Page init
$t01_ajudok_edit->Page_Init();

// Page main
$t01_ajudok_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t01_ajudok_edit->Page_Render();
?>
...
var CurrentForm = ft01_ajudokedit = new ew_Form("ft01_ajudokedit", "edit");

// Validate form
ft01_ajudokedit.Validate = function() {
...
ft01_ajudokedit.Form_CustomValidate = 
...
ft01_ajudokedit.ValidateRequired = true;
<?php } else { ?>
ft01_ajudokedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t01_ajudok_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t01_ajudok_edit->ShowPageHeader(); ?>
<?php
$t01_ajudok_edit->ShowMessage();
?>
<?php if (!$t01_ajudok_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t01_ajudok_edit->Pager)) $t01_ajudok_edit->Pager = new cPrevNextPager($t01_ajudok_edit->StartRec, $t01_ajudok_edit->DisplayRecs, $t01_ajudok_edit->TotalRecs) ?>
<?php if ($t01_ajudok_edit->Pager->RecordCount > 0 && $t01_ajudok_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t01_ajudok_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t01_ajudok_edit->PageUrl() ?>start=<?php echo $t01_ajudok_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t01_ajudok_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t01_ajudok_edit->PageUrl() ?>start=<?php echo $t01_ajudok_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t01_ajudok_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t01_ajudok_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t01_ajudok_edit->PageUrl() ?>start=<?php echo $t01_ajudok_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t01_ajudok_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t01_ajudok_edit->PageUrl() ?>start=<?php echo $t01_ajudok_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t01_ajudok_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft01_ajudokedit" id="ft01_ajudokedit" class="<?php echo $t01_ajudok_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t01_ajudok_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t01_ajudok_edit->Token ?>">
<?php } ?>
...
<?php if ($t01_ajudok->ajudok_id->Visible) { // ajudok_id ?>
	<div id="r_ajudok_id" class="form-group">
		<label id="elh_t01_ajudok_ajudok_id" class="col-sm-2 control-label ewLabel"><?php echo $t01_ajudok->ajudok_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t01_ajudok->ajudok_id->CellAttributes() ?>>
<span id="el_t01_ajudok_ajudok_id">
<span<?php echo $t01_ajudok->ajudok_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t01_ajudok->ajudok_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t01_ajudok" data-field="x_ajudok_id" name="x_ajudok_id" id="x_ajudok_id" value="<?php echo ew_HtmlEncode($t01_ajudok->ajudok_id->CurrentValue) ?>">
<?php echo $t01_ajudok->ajudok_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t01_ajudok_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t01_ajudok_edit->Pager)) $t01_ajudok_edit->Pager = new cPrevNextPager($t01_ajudok_edit->StartRec, $t01_ajudok_edit->DisplayRecs, $t01_ajudok_edit->TotalRecs) ?>
<?php if ($t01_ajudok_edit->Pager->RecordCount > 0 && $t01_ajudok_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
ft01_ajudokedit.Init();
</script>
<?php
$t01_ajudok_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t01_ajudok_edit->Page_Terminate();
?>
